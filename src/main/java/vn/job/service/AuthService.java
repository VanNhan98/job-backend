    ...
    public class AuthService {
        ...
        public TokenResponse refresh(HttpServletRequest request) {
            ...
            // check token into db
            Optional<Token> tokenDB = tokenService.findTokenByEmail(email);
            if (tokenDB.isEmpty() || !tokenDB.get().getRefreshToken().equals(refreshToken)) {
                throw new InvalidDataException("Token is invalid or does not match");
            }
        ...
        public String logout(HttpServletRequest request, HttpServletResponse response) {
            ...
            Optional<Token> currentToken = this.tokenService.findTokenByEmail(email);

            // delete token in database
            String result = this.tokenService.deleteToken(currentToken.orElse(null));
